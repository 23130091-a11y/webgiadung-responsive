 ...
 * @author CTT VNPAY
 */
@WebServlet(name = "ajaxServlet", value = "/ajax-vnpay")
public class ajaxServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        handleVnPay(req, resp);
    }
    ...
    private void handleVnPay(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        OrderAdmin order = orderDao.findById(orderId);
